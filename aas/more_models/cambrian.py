...
def eval_model(args):
    ...
    for i in tqdm(range(len(image_files))):
        ...
        new_feature_width, new_feature_height, width_padding, height_padding = get_unpad_feature_size(args.feature_width, args.feature_height, image.width, image.height)
